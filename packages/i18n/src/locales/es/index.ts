...
"importConfirm": "Las extensiones importadas se ejecutan en el proceso del agente con el mismo acceso que sus propias herramientas. Las habilidades declaradas pueden añadir instrucciones al agente y las dependencias declaradas se instalan con npm (scripts de instalación desactivados). ¿Continuar?",
    ...
    "permissions": {
      ...
      "provider.request": "Enviar solicitudes autenticadas a sus proveedores",
    ...
    "permissionHelp": {
      ...
      "provider.request": "Puede enviar una solicitud autenticada a cualquier ruta de un proveedor que haya configurado, usando su credencial guardada. Eso alcanza puntos finales que gastan dinero o leen su cuenta; el complemento nunca recibe la clave.",
