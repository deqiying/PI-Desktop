...
"importConfirm": "Importierte Erweiterungen laufen im Agentenprozess mit denselben Rechten wie die Tools des Agenten. Deklarierte Skills können dem Agenten Anweisungen hinzufügen, und deklarierte Abhängigkeiten werden mit npm installiert (Installationsskripte deaktiviert). Fortfahren?",
    ...
    "permissions": {
      ...
      "provider.request": "Authentifizierte Anfragen an Ihre Anbieter senden",
    ...
    "permissionHelp": {
      ...
      "provider.request": "Kann mit Ihrem gespeicherten Schlüssel eine authentifizierte Anfrage an einen beliebigen Pfad eines Anbieters senden, den Sie eingerichtet haben. Das erreicht Endpunkte, die Geld kosten oder Ihr Konto lesen; den Schlüssel selbst erhält das Plugin nie.",
